      ...
      <footer class="relative bg-gray-900 text-white px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-12 lg:py-24">
        <div class="flex flex-col md:flex-row">
          <div class="w-full lg:w-2/6 lg:mx-4 lg:pr-8">
            ...
            <p class="text-gray-400">We are thrilled to bring you a happy, healthy smile that you can be proud of.</p>
            ...
            <ul class="mt-4">
              <li>
                <a href="#" title="" class="block flex items-center opacity-75 hover:opacity-100">
                  ...
                  <span class="ml-3">
                    House No 1, Sector 17, Chandigarh
                  </span>
                </a>
              </li>
              <li class="mt-4">
          ...
          <div class="w-full lg:w-1/6 mt-8 lg:mt-0 lg:mx-4">
            ...
            <p class="text-sm text-gray-400 mt-12"> © DentalPro 2025. <br class="hidden lg:block" />All Rights Reserved.
            </p>
          </div>
        </div>
      </footer>
